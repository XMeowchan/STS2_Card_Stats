...
$indexLines = @(
    ...
    "    .usage-stage h2 { margin-bottom: 8px; }",
    "    .usage-lede { color: var(--muted); max-width: 52em; }",
    "    .chart-shell--standalone { margin-top: 16px; border: 0; background: transparent; border-radius: 28px; }",
    "    .usage-note { margin-top: 12px; font-size: 15px; color: var(--muted); }",
    ...
    "      <p class='usage-lede'>$sectionUsageBody</p>",
    "      <div class='chart-shell chart-shell--standalone'>",
    "        <img class='chart-image' src='users-history.svg' alt='STS2 mod user curve'>",
    "      </div>",
    "      <p class='usage-note'>$usageStatusText &middot; <a href='usage-stats.json'>$labelUsageJson</a> &middot; $($labelCumulativeUsers): $usageCumulativeUsers &middot; $($labelActiveUsers): $usageActiveUsers &middot; $($labelLatestDay): $usageLatestDay</p>",
    "    </section>",
    "",
